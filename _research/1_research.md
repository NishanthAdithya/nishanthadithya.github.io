...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/symb_comp.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
Algorithms
Manipulation and Physics Simulation 
Optimization 
