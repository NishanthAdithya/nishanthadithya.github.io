...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "Some of my relevent projects.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "exp-singularity-free-path-planning-and-safe-working-zone-computation-for-parallel-manipulators",
          ...
          section: "Exp",handler: () => {
              window.location.href = "/exp/1_exp/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%63%68%61%6E%64%72%61%6D%6F%75%6C%69@%77%70%69.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/NishanthAdithya", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/nishanth-adithya-chandramouli-0245981ab/", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0009-0375-9438", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=wWZ9CwAAAAJ", "_blank");
        },
      },{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/CV_summer_2026.pdf", "_blank");
        },
      },{
      id: 'light-theme',
